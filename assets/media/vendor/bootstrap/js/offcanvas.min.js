...
const NAME = "offcanvas",
  ...
  Default = { backdrop: !0, keyboard: !0, scroll: !1 },
  DefaultType = {
...
if (
  ...
  const e = Joomla.getOptions("bootstrap.offcanvas");
  "object" == typeof e &&
    null !== e &&
    Object.keys(e).forEach((t) => {
      const s = e[t],
        i = {
          backdrop: !s.backdrop || s.backdrop,
          keyboard: !s.keyboard || s.keyboard,
          scroll: !s.scroll || s.scroll,
        },
        a = Array.from(document.querySelectorAll(t));
      a.length && a.map((e) => new window.bootstrap.Offcanvas(e, i));
    });
}
