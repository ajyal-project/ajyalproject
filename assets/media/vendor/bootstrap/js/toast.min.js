...
if (
  ...
  const e = Joomla.getOptions("bootstrap.toast");
  "object" == typeof e &&
    null !== e &&
    Object.keys(e).forEach((t) => {
      const s = e[t],
        i = {
          animation: !s.animation || s.animation,
          autohide: !s.autohide || s.autohide,
          delay: s.delay ? s.delay : 5e3,
        },
        n = Array.from(document.querySelectorAll(t));
      n.length && n.map((e) => new window.bootstrap.Toast(e, i));
    });
}
export { Toast as T };
