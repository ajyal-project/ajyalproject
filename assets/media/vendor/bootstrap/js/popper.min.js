...
function getBoundingClientRect(e, t, n) {
  ...
  t &&
    isHTMLElement(e) &&
    ((o = (e.offsetWidth > 0 && round(r.width) / e.offsetWidth) || 1),
    (i = (e.offsetHeight > 0 && round(r.height) / e.offsetHeight) || 1));
...
function getOffsetParent(e) {
  ...
  return n &&
    ("html" === getNodeName(n) ||
      ("body" === getNodeName(n) && "static" === getComputedStyle(n).position))
    ? t
...
function arrow(e) {
  var t,
    ...
    s = getBasePlacement(n.placement),
    f = getMainAxisFromPlacement(s),
  ...
  if (i && a) {
    var p = toPaddingObject(o.padding, n),
      ...
      u = "y" === f ? bottom : right,
      m =
        n.rects.reference[l] + n.rects.reference[f] - a[f] - n.rects.popper[l],
      ...
      x = within(b, O, w),
      P = f;
    n.modifiersData[r] = (((t = {})[P] = x), (t.centerOffset = x - O), t);
  }
}
function effect$1(e) {
  var t = e.state,
...
function roundOffsetsByDPR(e) {
  ...
  return { x: round(t * r) / r || 0, y: round(n * r) / r || 0 };
}
function mapToStyles(e) {
  var t,
    ...
    m = a.y,
    g = void 0 === m ? 0 : m,
    h = "function" == typeof p ? p({ x: u, y: g }) : { x: u, y: g };
  (u = h.x), (g = h.y);
  var v = a.hasOwnProperty("x"),
    ...
    O = window;
  if (l) {
    var x = getOffsetParent(n),
      P = "clientHeight",
      S = "clientWidth";
    if (
      (x === getWindow(n) &&
        "static" !== getComputedStyle((x = getDocumentElement(n))).position &&
        "absolute" === s &&
      ...
      (w = bottom),
        (g -=
          (c && x === O && O.visualViewport ? O.visualViewport.height : x[P]) -
          r.height),
        (g *= f ? 1 : -1);
    if (o === left || ((o === top || o === bottom) && i === end))
      (b = right),
        (u -=
          (c && x === O && O.visualViewport ? O.visualViewport.width : x[S]) -
          r.width),
        (u *= f ? 1 : -1);
  }
  var E,
    M = Object.assign({ position: s }, l && unsetSides),
    R = !0 === p ? roundOffsetsByDPR({ x: u, y: g }) : { x: u, y: g };
  return (
    (u = R.x),
    (g = R.y),
    f
...
function getViewportRect(e, t) {
  ...
  return { width: i, height: a, x: s + getWindowScrollBarX(e), y: f };
}
function getDocumentRect(e) {
  var t,
    ...
    s = -r.scrollLeft + getWindowScrollBarX(e),
    f = -r.scrollTop;
  return (
    "rtl" === getComputedStyle(o || n).direction &&
      (s += max(n.clientWidth, o ? o.clientWidth : 0) - i),
...
function getClippingParents(e) {
  var t = listScrollParents(getParentNode(e)),
    n =
      ["absolute", "fixed"].indexOf(getComputedStyle(e).position) >= 0 &&
      isHTMLElement(e)
        ? getOffsetParent(e)
        : e;
  return isElement(n)
...
function getClippingRect(e, t, n, r) {
  var o = "clippingParents" === t ? getClippingParents(e) : [].concat(t),
    i = [].concat(o, [n]),
    a = i[0],
    s = i.reduce(function (t, n) {
      var o = getClientRectFromMixedType(e, n, r);
      return (
        (t.top = max(o.top, t.top)),
        (t.right = min(o.right, t.right)),
        (t.bottom = min(o.bottom, t.bottom)),
        (t.left = max(o.left, t.left)),
        t
      );
    }, getClientRectFromMixedType(e, a, r));
  return (
...
function detectOverflow(e, t) {
  ...
  var n = t,
    ...
    g = n.padding,
    h = void 0 === g ? 0 : g,
    v = mergePaddingObject(
      "number" != typeof h ? h : expandToHashMap(h, basePlacements)
    ),
    y = d === popper ? reference : popper,
    b = e.rects.popper,
    w = e.elements[m ? y : d],
    O = getClippingRect(
      isElement(w)
        ? w
        : w.contextElement || getDocumentElement(e.elements.popper),
      f,
      p,
      a
    ),
    ...
    S = rectToClientRect(Object.assign({}, b, P)),
    E = d === popper ? S : x,
    M = {
      top: O.top - E.top + v.top,
      bottom: E.bottom - O.bottom + v.bottom,
      left: O.left - E.left + v.left,
      right: E.right - O.right + v.right,
    },
...
function flip(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (
      ...
      var M = b[E],
        R = getBasePlacement(M),
        T = getVariation(M) === start,
        L = [top, bottom].indexOf(R) >= 0,
        C = L ? "width" : "height",
        W = detectOverflow(t, {
          placement: M,
          boundary: p,
        ...
        A = L ? (T ? right : left) : T ? bottom : top;
      w[C] > O[C] && (A = getOppositePlacement(A));
      var B = getOppositePlacement(A),
        D = [];
      if (
        (i && D.push(W[R] <= 0),
        s && D.push(W[A] <= 0, W[B] <= 0),
        D.every(function (e) {
          return e;
        }))
      ) {
  ...
  if (x) {
    if (i) {
      var L,
        ...
        H = y === start ? -S[A] : -P[A],
        V = t.elements.arrow,
        k = u && V ? getLayoutRect(V) : { width: 0, height: 0 },
        ...
        q = F[W],
        I = within(0, P[A], k[A]),
        _ = b ? P[A] / 2 - N - I - U - M.mainAxis : $ - I - U - M.mainAxis,
        X = b ? -P[A] / 2 + N + I + q + M.mainAxis : H + I + q + M.mainAxis,
        G = t.elements.arrow && getOffsetParent(t.elements.arrow),
        z = G ? ("y" === w ? G.clientTop || 0 : G.clientLeft || 0) : 0,
        Y = null != (L = null == R ? void 0 : R[w]) ? L : 0,
        J = B + X - Y,
        K = within(u ? min(D, B + _ - Y - z) : D, B, u ? max(j, J) : j);
      (x[w] = K), (T[w] = K - B);
    }
    if (s) {
      var Q,
        ...
        re = te + h[Z],
        oe = te - h[ee],
        ie = -1 !== [top, left].indexOf(v),
        ae = null != (Q = null == R ? void 0 : R[O]) ? Q : 0,
        se = ie ? re : te - P[ne] - S[ne] - ae + M.altAxis,
        fe = ie ? te + P[ne] + S[ne] - ae - M.altAxis : oe,
        le =
          u && ie
            ? withinMaxClamp(se, te, fe)
            : within(u ? se : re, te, u ? fe : oe);
      (x[O] = le), (T[O] = le - te);
    }
    t.modifiersData[r] = T;
  }
  ...
  return (
    (r || (!r && !n)) &&
      (("body" !== getNodeName(t) || isScrollParent(i)) &&
        (s = getNodeScroll(t)),
      isHTMLElement(t)
        ? (((f = getBoundingClientRect(t, !0)).x += t.clientLeft),
          (f.y += t.clientTop))
        : i && (f.x = getWindowScrollBarX(i))),
    {
...
function popperGenerator(e) {
  ...
  return function (e, t, n) {
    ...
    var o = {
      ...
      f = {
        ...
        setOptions: function (n) {
          ...
          var p = orderModifiers(
            mergeByName([].concat(r, o.options.modifiers))
          );
          return (
            ...
            o.orderedModifiers.forEach(function (e) {
              ...
              if ("function" == typeof i) {
                var s = i({ state: o, name: t, instance: f, options: r }),
                  l = function () {};
                a.push(s || l);
              }
            }),
            ...
            if (areValidElements(t, n)) {
              ...
              for (var r = 0; r < o.orderedModifiers.length; r++)
                if (!0 !== o.reset) {
                  ...
                  "function" == typeof a &&
                    (o =
                      a({ state: o, options: p, name: c, instance: f }) || o);
                } else (o.reset = !1), (r = -1);
            }
          }
        },
    ...
    if (!areValidElements(e, t)) return f;
    function l() {
