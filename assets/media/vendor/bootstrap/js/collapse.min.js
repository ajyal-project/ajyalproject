...
const NAME = "collapse",
  ...
  Default = { parent: null, toggle: !0 },
  DefaultType = { parent: "(null|element)", toggle: "boolean" };
class Collapse extends BaseComponent {
  constructor(e, t) {
    super(e, t), (this._isTransitioning = !1), (this._triggerArray = []);
    const s = SelectorEngine.find(SELECTOR_DATA_TOGGLE);
    for (const e of s) {
  ...
  _initializeChildren() {
    ...
    const e = this._getFirstLevelChildren(SELECTOR_DATA_TOGGLE);
    for (const t of e) {
...
if (
  ...
  Object.keys(e).forEach((t) => {
    const s = e[t],
      n = { toggle: !s.toggle || s.toggle };
    s.parent && (n.parent = s.parent);
    const i = Array.from(document.querySelectorAll(t));
    i.length && i.map((e) => new window.bootstrap.Collapse(e, n));
  });
}
