const MAX_UID = 1e6,
  ...
  executeAfterTransition = function (e, t) {
    ...
    const o = (n) => {
      let { target: s } = n;
      s === t &&
        ((i = !0), t.removeEventListener(TRANSITION_END, o), execute(e));
    };
    t.addEventListener(TRANSITION_END, o),
      setTimeout(() => {
        i || triggerTransitionEnd(t);
      }, n);
  },
  ...
  return function i(o) {
    ...
    for (let { target: r } = o; r && r !== this; r = r.parentNode)
      for (const a of s)
        if (a === r)
          return (
            hydrateObj(o, { delegateTarget: r }),
            i.oneOff && EventHandler.off(e, o.type, t, n),
            n.apply(r, [o])
          );
  };
}
...
function normalizeParameters(e, t, n) {
  ...
  return nativeEvents.has(s) || (s = e), [i, o, s];
}
function addHandler(e, t, n, i, o) {
  if ("string" != typeof t || !e) return;
  let [s, r, a] = normalizeParameters(t, n, i);
...
const EventHandler = {
  ...
  off(e, t, n, i) {
    if ("string" != typeof t || !e) return;
    const [o, s, r] = normalizeParameters(t, n, i),
      a = r !== t,
    ...
    if (void 0 === s) {
      ...
      removeHandler(e, l, r, s, o ? n : null);
    }
  },
  trigger(e, t, n) {
...
const enableDismissTrigger = function (e) {
    let t =
    ...
    EventHandler.on(document, n, `[data-bs-dismiss="${i}"]`, function (n) {
      if (
        ...
        return;
      const o = getElementFromSelector(this) || this.closest(`.${i}`);
  ...
  SWIPE_THRESHOLD = 40,
  Default$3 = { endCallback: null, leftCallback: null, rightCallback: null },
  DefaultType$3 = {
...
const NAME$2 = "backdrop",
  ...
  EVENT_MOUSEDOWN = `mousedown.bs.${NAME$2}`,
  Default$2 = {
...
const NAME$1 = "focustrap",
  ...
  Default$1 = { autofocus: !0, trapElement: null },
  DefaultType$1 = { autofocus: "boolean", trapElement: "element" };
...
function sanitizeHtml(e, t, n) {
  ...
  for (const e of o) {
    ...
    const i = [].concat(...e.attributes),
      o = [].concat(t["*"] || [], t[n] || []);
    for (const t of i) allowedAttribute(t, o) || e.removeAttribute(t.nodeName);
  }
...
export {
  ...
  Swipe as a,
  getNextActiveElement as b,
  isRTL as c,
  defineJQueryPlugin as d,
  enableDismissTrigger as e,
  getSelectorFromElement as f,
  getElementFromSelector as g,
  getElement as h,
  isVisible as i,
  isDisabled as j,
  isElement as k,
  ScrollBarHelper as l,
  Backdrop as m,
  noop as n,
  findShadowRoot as o,
  getUID as p,
  reflow as r,
  triggerTransitionEnd as t,
};
