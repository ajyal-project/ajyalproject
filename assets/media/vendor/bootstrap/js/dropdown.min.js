...
const NAME = "dropdown",
  ...
  SELECTOR_DATA_TOGGLE_SHOWN = `${SELECTOR_DATA_TOGGLE}.show`,
...
class Dropdown extends BaseComponent {
  ...
  show() {
    ...
    if (!EventHandler.trigger(this._element, EVENT_SHOW, e).defaultPrevented) {
      ...
      this._element.focus(),
        ...
        EventHandler.trigger(this._element, EVENT_SHOWN, e);
    }
  }
  hide() {
    if (isDisabled(this._element) || !this._isShown()) return;
  ...
  _completeHide(e) {
    if (!EventHandler.trigger(this._element, EVENT_HIDE, e).defaultPrevented) {
      ...
      this._popper && this._popper.destroy(),
        ...
        EventHandler.trigger(this._element, EVENT_HIDDEN, e);
    }
  }
  _getConfig(e) {
    if (
  ...
  _selectMenuItem(e) {
    ...
    const o = SelectorEngine.find(SELECTOR_VISIBLE_ITEMS, this._menu).filter(
      (e) => isVisible(e)
    );
    o.length &&
      getNextActiveElement(o, n, t === ARROW_DOWN_KEY, !o.includes(n)).focus();
  }
  ...
  static dataApiKeydownHandler(e) {
    const t = /input|textarea/i.test(e.target.tagName),
      n = "Escape" === e.key,
      o = [ARROW_UP_KEY, ARROW_DOWN_KEY].includes(e.key);
    if (!o && !n) return;
    if (t && !n) return;
    e.preventDefault();
    const r = this.matches(SELECTOR_DATA_TOGGLE)
        ? this
      ...
      s = Dropdown.getOrCreateInstance(r);
...
if (
  ...
  const e = Joomla.getOptions("bootstrap.dropdown");
  "object" == typeof e &&
    null !== e &&
    Object.keys(e).forEach((t) => {
      const n = e[t],
        o = {
          interval: n.interval ? n.interval : 5e3,
          pause: n.pause ? n.pause : "hover",
        },
        r = Array.from(document.querySelectorAll(t));
      r.length && r.map((e) => new window.bootstrap.Dropdown(e, o));
    });
}
