...
class Carousel extends BaseComponent {
  ...
  _setActiveIndicatorElement(e) {
    ...
    const i = SelectorEngine.findOne(
      `[data-bs-slide-to="${e}"]`,
  ...
  _slide(e) {
    ...
    const l = s ? CLASS_NAME_START : CLASS_NAME_END,
      E = s ? CLASS_NAME_NEXT : CLASS_NAME_PREV;
    n.classList.add(E), reflow(n), i.classList.add(l), n.classList.add(l);
    this._queueCallback(
      () => {
        n.classList.remove(l, E),
          n.classList.add("active"),
          i.classList.remove("active", E, l),
          (this._isSliding = !1),
          a(EVENT_SLID);
      },
      i,
...
if (
  (EventHandler.on(
    ...
    function (e) {
      ...
      e.preventDefault();
      const i = Carousel.getOrCreateInstance(t),
  ...
  const e = Joomla.getOptions("bootstrap.carousel");
  "object" == typeof e &&
    null !== e &&
    Object.keys(e).forEach((t) => {
      const i = e[t],
        s = {
          interval: i.interval ? i.interval : 5e3,
          keyboard: !i.keyboard || i.keyboard,
          pause: i.pause ? i.pause : "hover",
          slide: !!i.slide && i.slide,
          wrap: !i.wrap || i.wrap,
          touch: !i.touch || i.touch,
        },
        n = Array.from(document.querySelectorAll(t));
      n.length && n.map((e) => new window.bootstrap.Carousel(e, s));
    });
}
