const uriAttributes = new Set([
  ...
  allowedAttribute = (e, t) => {
    ...
    return t.includes(o)
      ...
      : t.filter((e) => e instanceof RegExp).some((e) => e.test(o));
  };
function sanitizeHtml(e, t, o) {
  ...
  for (const e of n) {
    ...
    const r = [].concat(...e.attributes),
      n = [].concat(t["*"] || [], t[o] || []);
    for (const t of r) allowedAttribute(t, n) || e.removeAttribute(t.nodeName);
  }
    ...
    (e.extend = (e, t) => {
      ...
      (e.Text = {
        ...
        _: (t, o) => {
          let r = t,
            n = o;
          const s = e.getOptions("joomla.jtext");
          return (
            s && (e.Text.load(s), e.loadOptions({ "joomla.jtext": null })),
            (n = void 0 === n ? r : n),
            (r = r.toUpperCase()),
      ...
      (e.submitbutton = (t, o, r) => {
        ...
        if (
          ...
          if (null == s) {
            ...
            o || (o = `${e[0]}.cancel`), (s = t !== o);
          }
          (s && !document.formvalidator.isValid(n)) || e.submitform(t, n);
        } else e.submitform(t);
      }),
      (e.checkAll = (e, t) => {
        if (!e.form) return !1;
      ...
      (e.isChecked = (e, t) => {
        ...
        let r,
          ...
          s,
          l = !0;
        for (r = 0, s = o.elements.length; r < s; r++)
          if (
            ((n = o.elements[r]),
        ...
        o.elements["checkall-toggle"].checked = l;
      }),
      (e.tableOrdering = (t, o, r, n) => {
        let s = n;
        void 0 === s
          ? (s = document.getElementById("adminForm"))
          : "string" == typeof n && (s = document.getElementById(n)),
          (s.filter_order.value = t),
          (s.filter_order_Dir.value = o),
          e.submitform(r, s);
      }),
      (e.listItemTask = (t, o, r = null) => {
        ...
        let l,
          a = 0;
        if (!s) return !1;
        for (; (l = n[`cb${a}`]), l; ) (l.checked = !1), (a += 1);
        return (
          (s.checked = !0), (n.boxchecked.value = 1), e.submitform(o, n), !1
        );
      }),
      (e.replaceTokens = (e) => {
            ...
            if (
              ...
              t &&
                ((!o.url.startsWith("http:") && !o.url.startsWith("https:")) ||
                  o.url.startsWith(window.location.origin)) &&
                n.setRequestHeader("X-CSRF-Token", t),
