!(function () {
  ...
  var u = (function (e) {
    ...
    function r() {
      var t;
      return (
        ((t = e.call(this) || this).close = t.close.bind(s(t))),
        (t.destroyCloseButton = t.destroyCloseButton.bind(s(t))),
        (t.createCloseButton = t.createCloseButton.bind(s(t))),
        (t.onMutation = t.onMutation.bind(s(t))),
        (t.observer = new MutationObserver(t.onMutation)),
        t.observer.observe(s(t), {
          attributes: !1,
          childList: !0,
          subtree: !0,
        }),
        t.addEventListener("animationend", function (e) {
          "joomla-alert-fade-in" === e.animationName &&
            e.target === s(t) &&
            (t.dispatchEvent(new CustomEvent("joomla.alert.shown")),
            t.style.removeProperty("animationName"));
        }),
        t.addEventListener("animationend", function (e) {
          "joomla-alert-fade-out" === e.animationName &&
            e.target === s(t) &&
            (t.dispatchEvent(new CustomEvent("joomla.alert.closed")),
            t.remove());
        }),
        t
      );
    ...
    (i = e),
      ((o = r).prototype = Object.create(i.prototype)),
    ...
    return (
      ...
      (d.attributeChangedCallback = function (t, e, n) {
        switch (t) {
          case "type":
            (!n ||
              (n &&
                -1 === ["info", "warning", "danger", "success"].indexOf(n))) &&
              (this.type = "info");
            break;
          case "role":
            (!n || (n && -1 === ["alert", "alertdialog"].indexOf(n))) &&
              (this.role = "alert");
            break;
          case "dismiss":
            (n && "" !== n) || (e && "" !== e)
              ? this.button && "false" === n
                ...
                : this.button || "false" === n || this.createCloseButton()
          ...
          case "close-text":
            (n && n === e) ||
              (this.button && this.button.setAttribute("aria-label", n));
            break;
          case "auto-dismiss":
            this.autoDismiss();
        }
      }),
      (d.onMutation = function (t) {
        for (var e, n = a(t); !(e = n()).done; ) {
          var o = e.value;
          "childList" === o.type &&
            o.addedNodes.length &&
            this.button &&
  ...
  customElements.get("joomla-alert") ||
    customElements.define("joomla-alert", u);
  var l = function (t) {
  ...
  (Joomla.renderMessages = function (t, e, n, o) {
    var i = l(e);
    (void 0 === n || (n && !1 === n)) && Joomla.removeMessages(i),
      [].slice.call(Object.keys(t)).forEach(function (e) {
        var n = e,
          s = t[e],
          r = document.createElement("joomla-alert");
        if (
          (["success", "info", "danger", "warning"].indexOf(e) < 0 &&
            ((n = "notice" === e ? "info" : e),
            (n = "message" === e ? "success" : n),
            (n = "error" === e ? "danger" : n),
            (n = "warning" === e ? "warning" : n)),
          r.setAttribute("type", n),
          r.setAttribute("close-text", Joomla.Text._("JCLOSE")),
          r.setAttribute("dismiss", !0),
          o && parseInt(o, 10) > 0 && r.setAttribute("auto-dismiss", o),
          void 0 !== Joomla.Text._(e))
        ) {
          var a = document.createElement("div");
          (a.className = "alert-heading"),
            (a.innerHTML = Joomla.sanitizeHtml(
              '<span class="' +
                e +
        ...
        (u.className = "alert-wrapper"),
          s.forEach(function (t) {
            u.innerHTML += Joomla.sanitizeHtml(
    ...
    (Joomla.removeMessages = function (t) {
      var e = l(t),
        n = [].slice.call(e.querySelectorAll("joomla-alert"));
      n.length &&
    ...
    document.addEventListener("DOMContentLoaded", function () {
      var t = Joomla.getOptions("joomla.messages");
      t &&
        Object.keys(t).map(function (e) {
          return Joomla.renderMessages(t[e], void 0, !0, void 0);
        });
    });
})();
