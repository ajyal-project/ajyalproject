...
(window.Modernizr = (function (t, e, i) {
  ...
  var l,
    ...
    T = function (t, i, n, s) {
      ...
      if (parseInt(n, 10))
        for (; n--; )
          ((a = e.createElement("div")).id = s ? s[n] : d + (n + 1)),
            h.appendChild(a);
      return (
  ...
  v))
    h(v, S) &&
      ((l = S.toLowerCase()), (u[l] = v[S]()), C.push((u[l] ? "" : "no-") + l));
  return (
    (u.addTest = function (t, e) {
      if ("object" == typeof t) for (var n in t) h(t, n) && u.addTest(n, t[n]);
      else {
  ...
  (function (t) {
    "function" == typeof define && define.amd
      ...
      ? (module.exports = t(require("jquery"), window.Modernizr))
    ...
    var a = e.prefixed("transition"),
      ...
      _ = "all",
      g = 0.001,
      v = window.getComputedStyle || function () {},
      C = function (t, e) {
    ...
    var b = (function () {
      ...
      S = function (e, i) {
        (i = i || {}),
          t.extend(this, S.options, i, S.settings),
          (this.$el = t(e)),
          (this.element = e),
          (this.unique = "shuffle_" + T++),
          this._fire(S.EventType.LOADING),
          this._init(),
          s(
            function () {
    ...
    return (
            ...
            return (
              ...
              0 >= p || p > i
                ? (clearTimeout(a),
                  ...
                  (r = e.apply(s, o)),
                  (s = o = null))
                : a || !1 === n.trailing || (a = setTimeout(h, p)),
              r
            );
          };
        },
      ...
      (S.Point = C),
      (S._getItemTransformString = function (t, e) {
        return f
          ? "translate3d(" +
              t.x +
              "px, " +
      ...
      (S._getNumberStyle = function (e, i, n) {
        if (m) {
          n = n || v(e, null);
          var s = S._getFloat(n[i]);
          return (
            b || "width" !== i
              ? b ||
                "height" !== i ||
                (s +=
                  S._getFloat(n.paddingTop) +
                  S._getFloat(n.paddingBottom) +
                  S._getFloat(n.borderTopWidth) +
                  S._getFloat(n.borderBottomWidth))
              : (s +=
                  S._getFloat(n.paddingLeft) +
                  S._getFloat(n.paddingRight) +
                  S._getFloat(n.borderLeftWidth) +
      ...
      (S._getOuterWidth = function (t, e) {
        ...
        e &&
          (n +=
            S._getNumberStyle(t, "marginLeft", i) +
            S._getNumberStyle(t, "marginRight", i));
        return n;
      }),
      (S._getOuterHeight = function (t, e) {
        ...
        e &&
          (n +=
            S._getNumberStyle(t, "marginTop", i) +
            S._getNumberStyle(t, "marginBottom", i));
        return n;
      }),
      ...
      (S.prototype._init = function () {
        (this.$items = this._getItems()),
          ...
          this.$el.addClass(S.ClassName.BASE),
          this._initItems(),
          E.on("resize." + y + "." + this.unique, this._getResizeFunction());
      ...
      (S.prototype._toggleFilterClasses = function (t, e) {
        t.removeClass(S.ClassName.CONCEALED).addClass(S.ClassName.FILTERED),
          e.removeClass(S.ClassName.FILTERED).addClass(S.ClassName.CONCEALED);
      }),
      (S.prototype._initItems = function (t) {
        (t = t || this.$items).addClass(
          [S.ClassName.SHUFFLE_ITEM, S.ClassName.FILTERED].join(" ")
        ),
          t.css(this.itemCss).data("point", new C()).data("scale", 1);
      }),
        ...
        return (
          0 ===
            (n = t.isFunction(this.columnWidth)
              ? this.columnWidth(e)
              : this.useSizer
              ? S._getOuterWidth(this.sizer)
              : this.columnWidth
              ? this.columnWidth
              : this.$items.length > 0
              ? S._getOuterWidth(this.$items[0], !0)
              : e) && (n = e),
          n + i
        );
      }),
      (S.prototype._getGutterSize = function (e) {
        return t.isFunction(this.gutterWidth)
          ? this.gutterWidth(e)
          : this.useSizer
          ? S._getNumberStyle(this.sizer, "marginLeft")
          : this.gutterWidth;
      }),
      (S.prototype._setColumns = function (t) {
        var e = t || S._getOuterWidth(this.element),
          ...
          s = (e + i) / n;
        Math.abs(Math.round(s) - s) < this.columnThreshold &&
          (s = Math.round(s)),
      ...
      (S.prototype._getItemPosition = function (t) {
        for (
          var e = this._getColumnSpan(t.width, this.colWidth, this.cols),
            ...
            s = new C(Math.round(this.colWidth * n), Math.round(i[n])),
            o = i[n] + t.height,
      ...
      (S.prototype._getColumnSpan = function (t, e, i) {
        var n = t / e;
        return (
          Math.abs(Math.round(n) - n) < this.columnThreshold &&
            (n = Math.round(n)),
      ...
      (S.prototype._onResize = function () {
        this.enabled &&
          !this.destroyed &&
          S._getOuterWidth(this.element) !== this.containerWidth &&
          this.update();
      }),
      (S.prototype._getStylesForTransition = function (t) {
        ...
        return (
          this.supported
            ? (e[p] = S._getItemTransformString(t.point, t.scale))
      ...
      (S.prototype._startItemAnimation = function (e, i, n, s) {
        function o(e) {
          e.target === e.currentTarget &&
            (t(e.target).off(u, o), r._removeTransitionReference(a), s());
        }
        var r = this,
          a = { $element: e, handler: o };
        if ((n(), !this.initialized)) return e.css(i), void s();
        if (this.supported) e.css(i), e.on(u, o), this._transitions.push(a);
        else {
          var l = e.stop(!0).animate(i, this.speed, "swing", s);
      ...
      (S.prototype._processStyleQueue = function (e) {
        ...
        n(
          ...
          i.length > 0 && this.initialized && this.speed > 0
            ? ((this.isTransitioning = !0),
              this.supported
                ? this._whenCollectionDone(i, u, this._movementFinished)
      ...
      (S.prototype._cancelMovement = function () {
        this.supported
          ? n(this._transitions, function (t) {
              t.$element.off(u, t.handler);
            })
        ...
        s(
          function () {
            n(
              ...
              this._whenCollectionDone(t(e), u, function () {
      ...
      (S.prototype._whenCollectionDone = function (e, i, n) {
        function s(e) {
          e.target === e.currentTarget &&
            (t(e.target).off(i, s),
            ++o === r && (a._removeTransitionReference(l), n.call(a)));
        }
        var o = 0,
          r = e.length,
          a = this,
          l = { $element: e, handler: s };
        e.on(i, s), this._transitions.push(l);
      }),
      (S.prototype._whenAnimationsDone = function (e) {
        t.when.apply(null, this._animations).always(
          t.proxy(function () {
            (this._animations.length = 0),
              this._isMovementCanceled || e.call(this);
          }, this)
        );
      }),
      ...
      (S.prototype.remove = function (e) {
        e.length &&
          ...
          this.sort(),
          this.$el.one(
            S.EventType.LAYOUT + "." + y,
            t.proxy(function () {
              e.remove(),
                (this.$items = this._getItems()),
                this._updateItemCount(),
                this._fire(S.EventType.REMOVED, [e, this]),
                (e = null);
            }, this)
          ));
      }),
      (S.prototype.destroy = function () {
        E.off("." + this.unique),
          this.$el.removeClass(y).removeAttr("style").removeData(y),
          this.$items
            .removeAttr("style")
            .removeData("point")
            .removeData("scale")
            .removeClass(
              [
                S.ClassName.CONCEALED,
                S.ClassName.FILTERED,
                S.ClassName.SHUFFLE_ITEM,
              ].join(" ")
            ),
          (this.$items = null),
          (this.$el = null),
